...
<body>
    <main class="w3-monospace">
        ...
        <section class=" w3-card w3-container box">
            <form method="POST" action="model/crud/create.php" enctype="multipart/form-data" id="formImg" class="w3-padding w3-margin-bottom form-box">
                ...
                <div id="ErroNome" class="w3-padding w3-round w3-panel w3-red alert">
                    <p class="">
                ...
                <div id="ErroImg" class="w3-round w3-padding w3-panel w3-red alert">
                    <p class="">
